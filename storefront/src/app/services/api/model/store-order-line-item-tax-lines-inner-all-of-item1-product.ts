 ...
 * The item\'s product.
 */
export interface StoreOrderLineItemTaxLinesInnerAllOfItem1Product { 
    /**
     ...
     */
    status: StoreOrderLineItemTaxLinesInnerAllOfItem1Product.StatusEnum;
    /**
...
export namespace StoreOrderLineItemTaxLinesInnerAllOfItem1Product {
